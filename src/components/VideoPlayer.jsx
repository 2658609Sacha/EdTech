...
export default function VideoPlayer({ video, onBack, allVideos, theme }) {
  ...
  return (
    <div style={{ padding: "32px 40px", maxWidth: 1200 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 320px", gap: 32 }}>
        <div>
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                height: 3, background: theme.cardBorder,
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <button style={{ background: "none", border: "none", cursor: "pointer", color: theme.primaryText, fontSize: 18, padding: 0 }}>
                    <i className="ti ti-player-play" />
                  </button>
                  <button style={{ background: "none", border: "none", cursor: "pointer", color: theme.secondaryText, fontSize: 16, padding: 0 }}>
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
              ...
              <span style={{ color: theme.secondaryText, fontSize: 12 }}>·</span>
              <span style={{ fontSize: 12, color: theme.mutedText }}>{video.views} views</span>
            </div>
            <h1 style={{
              fontFamily: "'DM Serif Display', serif",
              fontSize: 24, fontWeight: 400,
              color: theme.primaryText, margin: "0 0 12px",
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div>
                  <p style={{ fontSize: 13, fontWeight: 500, color: theme.primaryText, margin: 0 }}>{video.instructor}</p>
                  <p style={{ fontSize: 11, color: theme.mutedText, margin: 0 }}>{video.subject} Faculty</p>
                </div>
              </div>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                {[
                  ...
                  onMouseEnter={e => { e.currentTarget.style.background = theme.buttonBg; e.currentTarget.style.color = theme.primaryText; }}
                  onMouseLeave={e => { e.currentTarget.style.background = theme.secondarySurface; e.currentTarget.style.color = theme.secondaryText; }}
                  >
        ...
        <div>
          <h3 style={{ fontSize: 14, fontWeight: 500, color: theme.mutedText, marginBottom: 16 }}>Up next</h3>
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {related.map(v => (
              <VideoCard key={v.id} video={v} onClick={() => {}} theme={theme} />
            ))}
          </div>
        </div>
      </div>
